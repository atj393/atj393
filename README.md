...
<table>
  <tr>
    <td colspan="2" valign="top">
      ...
      &nbsp;<b><a href="https://github.com/atj393/automatist-android">Automatist</a></b> &nbsp;<sub>MOBILE-FIRST AI AUTOMATION · IN CLOSED TESTING</sub><br>
      &nbsp;<sub>Recurring AI tasks, scheduled from a phone, with a real choice between cloud, on-device, and offline models. Free and open source.</sub><br>
      &nbsp;<sub><code>Kotlin</code> <code>Jetpack Compose</code> <code>MediaPipe</code> &nbsp;·&nbsp; <a href="https://automatist.cloud/">Website</a> · <a href="https://github.com/atj393/automatist-android">Source</a></sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <b><a href="https://github.com/atj393/easy-web-navigation">Easy Web Navigation</a></b><br>
      <sub>Focus order, landmarks, and the tab path, drawn straight onto the page instead of filed as a report.</sub><br>
      <sub><a href="https://chromewebstore.google.com/detail/easy-web-navigation-keybo/jaffeipdpljhnfonacndcpjdkclgjiln">Chrome Web Store</a> · <a href="https://github.com/atj393/easy-web-navigation">Source</a></sub>
    </td>
    <td width="50%" valign="top">
      <b><a href="https://github.com/atj393/re-phraser">Re-Phraser</a></b><br>
      <sub>Your selection goes to the AI tab you already have open. No backend, no API-key box.</sub><br>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <b><a href="https://play.google.com/store/apps/details?id=com.psalmswayapp">Psalms Way</a></b><br>
      <sub>A localized React Native reader on Google Play, plus an offline Chrome companion.</sub><br>
...
<sub><b>THE LAB</b> · <a href="https://github.com/atj393/local-browser-automation-bridge">local-browser-automation-bridge</a>, where I go to learn the back half: a React dashboard, an Express API, a SQLite queue, and a WebSocket bridge, all talking locally. &nbsp; <b>TOOLING</b> · my code-cleanup workflow as a <a href="https://github.com/atj393/claude-plugin-code-cleanup">Claude Code plugin</a> and its <a href="https://github.com/atj393/claude-plugins">marketplace</a>.</sub>

<sub><b>02 · THE STACK</b></sub>

`TypeScript` `React` `Angular` `Node.js` `Kotlin` `Jetpack Compose` `React Native` `Chrome MV3` `Express` `SQLite` `MediaPipe` `Playwright` `GitHub Actions`
...
[Five-time LinkedIn Top Voice](https://www.linkedin.com/in/atj393/) · [verified credentials from Meta, Google, and IBM](https://www.credly.com/users/atj393) · fixes sent upstream, like [repeat-visit caching](https://github.com/Octasol/octasol/pull/21) and [safer production logging](https://github.com/Octasol/octasol/pull/5) for Octasol
